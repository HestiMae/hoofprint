...
public class BlockConstants {
	...
	public static final List<Block> GRASS_BLOCKS = List.of(Blocks.GRASS, Blocks.TALL_GRASS,
	...
	public static final List<Block> STONE_BLOCKS = List.of(Blocks.STONE, Blocks.ANDESITE, Blocks.TUFF);
	public static final List<Block> ICE_BLOCKS = List.of(Blocks.ICE, Blocks.PACKED_ICE, Blocks.BLUE_ICE);
