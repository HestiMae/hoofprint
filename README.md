...
A minimalist clientside map frontend for Surveyor.<br/>
...
This mod is a collaboration between [GardenSystem](https://modrinth.com/user/GardenSystem) (see also, [SurveyorSurveyor](https://github.com/HestiMae/surveyor-surveyor)) and [Sisby folk](https://modrinth.com/user/sisby-folk), and was enabled by advice from many others.
